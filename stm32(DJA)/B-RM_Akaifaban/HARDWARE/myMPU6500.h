#ifndef __MY_MPU6500_H
#define __MY_MPU6500_H

#include "main.h"		//内包含#include "stm32f4xx_hal.h"
#include "filter.h"
						
#define MPU6500_NSS_HIGH  HAL_GPIO_WritePin(MPU6500_NSS_GPIO_Port,MPU6500_NSS_Pin,GPIO_PIN_SET)				//MPU6500片选脚拉高
#define MPU6500_NSS_LOW   HAL_GPIO_WritePin(MPU6500_NSS_GPIO_Port,MPU6500_NSS_Pin,GPIO_PIN_RESET)			//MPU6500片选脚低
